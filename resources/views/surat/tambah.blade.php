    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/suratkeluar/simpan') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('no_agenda') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no_agenda" type="text" class="form-control" name="no_agenda" value="{{ old('no_agenda') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('tujuan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tujuan" type="text" class="form-control" name="tujuan" value="{{ old('tujuan') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('no_surat') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no_surat" type="Number" class="form-control" name="no_surat" required>
                        ...
                        <div class="form-group{{ $errors->has('isi_ringkas') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="isi_ringkas" name="isi_ringkas"></textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <button type="reset" class="btn btn-reset">
                                    <a href="" onclick="window.history.back();" style="text-decoration: none;">Kembali</a>
                                </button>
                            </div>
                        </div>
                    </form>
